...
package com.github.lanif.sys.modular.user.enums;
 ...
 * @date 2020/3/23 9:32
 */
@ExpEnumType(module = SysExpEnumConstant.LANIF_SYS_MODULE_EXP_CODE, kind = SysExpEnumConstant.SYS_USER_EXCEPTION_ENUM)
