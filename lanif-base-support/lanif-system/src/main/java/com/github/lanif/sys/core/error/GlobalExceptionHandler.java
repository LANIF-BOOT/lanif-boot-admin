...
package com.github.lanif.sys.core.error;
...
import com.github.lanif.core.exception.AuthException;
import com.github.lanif.core.exception.DemoException;
import com.github.lanif.core.exception.PermissionException;
import com.github.lanif.core.exception.ServiceException;
import com.github.lanif.core.exception.enums.*;
import com.github.lanif.core.exception.enums.abs.AbstractBaseExceptionEnum;
import com.github.lanif.core.pojo.response.ErrorResponseData;
import com.github.lanif.core.util.ResponseUtil;
...
import static com.github.lanif.core.consts.AopSortConstant.GLOBAL_EXP_HANDLER_AOP;
...
public class GlobalExceptionHandler {
    ...
    private ErrorResponseData renderJson(Integer code, String message, Throwable e) {
        if (ObjectUtil.isNotNull(e)) {
            ...
            //遍历所有堆栈信息，找到com.github开头的第一条异常信息
