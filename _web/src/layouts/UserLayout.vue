  ...
  <div id="userLayout" :class="['user-layout-wrapper', device]">
    <div class="container">
      <div class="top">
        <div class="header">
          <a href="/">
            ...
            <span class="title">Lanif 快速开发平台</span>
          </a>
        </div>
        <div class="desc">
          Lanif 是华夏最具影响力的 Web 快速开发平台
        </div>
      </div>
      ...
      <div class="footer">
        ...
        <div class="copyright">
          Copyright © 2020 <a target="_blank" href="https://www.github.cn/">github</a> All rights reserved. Lanif-Seperation v1.1.1
        </div>
      </div>
    </div>
  </div>
